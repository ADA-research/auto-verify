...
AbCrownConfigspaceAlt.add_conditions(
    [
        ...
        # ),
        NotEqualsCondition(
            AbCrownConfigspaceAlt["attack__attack_mode"],
...
for hp in AbCrownConfigspaceAlt.get_hyperparameters():
    ...
    AbCrownConfigspaceAlt.add_condition(
        EqualsCondition(
            hp,
...
for hp in AbCrownConfigspaceAlt.get_hyperparameters():
    ...
    AbCrownConfigspaceAlt.add_condition(
        NotEqualsCondition(
            hp, AbCrownConfigspaceAlt["attack__pgd_order"], "skip"
        )
    )

AbCrownConfigspaceAlt.add_forbidden_clauses(
    [
        # ForbiddenAndConjunction(
        #     ForbiddenEqualsClause(
