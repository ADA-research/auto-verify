...
AbCrownConfigspaceAlt = ConfigurationSpace(name="abcrown")
AbCrownConfigspaceAlt.add_hyperparameters(
    [
        # general
        # Categorical(
        #     "general__device",
...
AbCrownConfigspaceAlt.add_conditions(
    [
        EqualsCondition(
        ...
        EqualsCondition(
            AbCrownConfigspaceAlt["bab__branching__input_split__adv_check"],
            AbCrownConfigspaceAlt["bab__branching__input_split__enable"],
            True,
        ),
        EqualsCondition(
        ...
        # ),
        EqualsCondition(
            AbCrownConfigspaceAlt["solver__alpha-crown__lr_alpha"],
            AbCrownConfigspaceAlt["solver__alpha-crown__alpha"],
            True,
        ),
        EqualsCondition(
            AbCrownConfigspaceAlt["solver__alpha-crown__iteration"],
            AbCrownConfigspaceAlt["solver__alpha-crown__alpha"],
            True,
        ),
        EqualsCondition(
            AbCrownConfigspaceAlt["solver__alpha-crown__share_slopes"],
            AbCrownConfigspaceAlt["solver__alpha-crown__alpha"],
            True,
        ),
        EqualsCondition(
            AbCrownConfigspaceAlt["solver__alpha-crown__no_joint_opt"],
            AbCrownConfigspaceAlt["solver__alpha-crown__alpha"],
            True,
        ),
        EqualsCondition(
            AbCrownConfigspaceAlt["solver__alpha-crown__lr_decay"],
            AbCrownConfigspaceAlt["solver__alpha-crown__alpha"],
            True,
        ),
        EqualsCondition(
            AbCrownConfigspaceAlt["solver__alpha-crown__full_conv_alpha"],
            AbCrownConfigspaceAlt["solver__alpha-crown__alpha"],
            True,
        ),
        #         EqualsCondition(
        ...
        # ),
        # EqualsCondition(
        #     AbCrownConfigspace.get_hyperparameter("bab__attack__beam_depth"),
        #     AbCrownConfigspace.get_hyperparameter(
        #         "bab__attack__enabled",
        #     ),
        #     True,
        ...
        # ),
        # EqualsCondition(
        #     AbCrownConfigspace.get_hyperparameter("bab__attack__mip_timeout"),
        #     AbCrownConfigspace.get_hyperparameter(
        #         "bab__attack__enabled",
        #     ),
        #     True,
